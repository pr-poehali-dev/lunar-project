    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/0 backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 py-4 text-transparent">
        <div className="flex items-center gap-3">
          <span className="text-foreground font-mono text-sm tracking-widest font-bold">НЕЙРОБИОНИКА</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a href="#contact">
            ...
            >
              Смотреть презентацию <Icon name="ArrowUpRight" className="ml-1 h-4 w-4" />
            </Button>
          </a>
        </div>
      </div>
